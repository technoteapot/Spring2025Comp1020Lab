...
OBJECTS = main.o myString.o genericVector.o
#my variables:
...
genericVector.o: genericVector.h genericVector.c generic.h
	$(CC) $(CFLAGS) -c genericVector.c -o genericVector.o
